...
public class cform extends AppCompatActivity
    ...
    public void send(View view ){
        ...
        if(name.isEmpty())
        {
            Toast.makeText(this, "Morate unijeti tekst utiska da biste nastavili", Toast.LENGTH_SHORT).show(); return;}
        else
        {

            Intent intent = new Intent(Intent.ACTION_SENDTO);
            intent.setData(Uri.parse("mailto:voulezvouspd@gmail.com")); // only email apps should handle this
            intent.putExtra(Intent.EXTRA_SUBJECT, "Poslato sa android aplikacije");
